...
do
  ...
  n_gradient=$(cat ../saida.dat | grep -i -A 3 n_newtonDefault_gradient_$N | grep -i "rdtsc" | head -n 1 | cut -d , -f 2)
  o_gradient=$(cat ../saida.dat | grep -i -A 3 o_newtonDefault_gradient_$N | grep -i "rdtsc" | head -n 1 | cut -d , -f 2)
  n_hessian=$(cat ../saida.dat | grep -i -A 3 n_newtonDefault_hessian_$N | grep -i "rdtsc" | head -n 1 | cut -d , -f 2)
  o_hessian=$(cat ../saida.dat | grep -i -A 3 o_newtonDefault_hessian_$N | grep -i "rdtsc" | head -n 1 | cut -d , -f 2)
  n_newtonDefault_solver=$(cat ../saida.dat | grep -i -A 3 n_newtonDefault_solver_$N | grep -i "rdtsc" | head -n 1 | cut -d , -f 2)
  o_newtonDefault_solver=$(cat ../saida.dat | grep -i -A 3 o_newtonDefault_solver_$N | grep -i "rdtsc" | head -n 1 | cut -d , -f 2)
  ...
  n_newtonGS_solver=$(cat ../saida.dat | grep -i -A 3 n_newtonGS_solver_$N | grep -i "rdtsc" | head -n 1 | cut -d , -f 2)
  o_newtonGS_solver=$(cat ../saida.dat | grep -i -A 3 o_newtonGS_solver_$N | grep -i "rdtsc" | head -n 1 | cut -d , -f 2)
